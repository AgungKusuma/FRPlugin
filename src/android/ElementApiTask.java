...
public class ElementApiTask extends AsyncTask<Object, Void, Void> {
    ...
    public ElementApiTask(ApiTaskCallback apiTaskCallback, String endpoints) {
        ...
        this.builder = new Request.Builder().url("https://www.bchant.xyz:1501/".concat(endpoints)); // TODO: replace this with your base address
    ...
    protected Void doInBackground(Object... params) {
        ...
        try {
            ...
            apiTaskCallback.onResult(response + "" + apiTaskCallback.getContext().getPackageName().toString());

        } catch (Exception e) {
            apiTaskCallback.onException(e.getMessage() + apiTaskCallback.getContext().getPackageName().toString());
        }
